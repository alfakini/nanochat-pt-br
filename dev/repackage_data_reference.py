...
Currently, nanochat uses the Carolina corpus (Brazilian Portuguese).
...
https://huggingface.co/datasets/carolina-c4ai/corpus-carolina (source)
https://huggingface.co/datasets/karpathy/carolina-corpus-shuffled (converted)
...
For the Carolina corpus, see dev/repackage_carolina.py instead.
"""
